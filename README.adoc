...
image::https://sonar.villagecompute.com/api/project_badges/measure?project=gffft-server&metric=alert_status[]

[link=https://sonar.villagecompute.com/dashboard?id=gffft-server]
image::https://sonar.villagecompute.com/api/project_badges/measure?project=gffft-server&metric=coverage[]

[link=https://sonar.villagecompute.com/dashboard?id=gffft-server]
image::https://sonar.villagecompute.com/api/project_badges/measure?project=gffft-server&metric=sqale_rating[]

[link=https://sonar.villagecompute.com/dashboard?id=gffft-server]
image::https://sonar.villagecompute.com/api/project_badges/measure?project=gffft-server&metric=security_rating[]
